...
export const MortgageInputSchema=z.object({propertyPrice:finite.positive(),downPayment:nonNeg,annualRatePercent:ratePct,termMonths:z.number().int().positive().max(600)});
